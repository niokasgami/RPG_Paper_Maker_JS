    ...
    read(json)
    {
        ...
        case EffectKind.Damages:
            ...
            case DamagesKind.Stat:
                this.damageStatisticID = DynamicValue.readOrDefaultDatabase(json
                    .dsid);
                break;
            case DamagesKind.Currency:
                this.damageCurrencyID = DynamicValue.readOrDefaultDatabase(json
                    .dcid);
                break;
            ...
            this.damagesMinimumFormula = DynamicValue.readOrDefaultMessage(json
                .dmin, RPM.STRING_ZERO);
            this.isDamagesMaximum = RPM.defaultValue(json.idmax, false);
            this.damagesMaximumFormula = DynamicValue.readOrDefaultMessage(json
            ...
            this.damageVarianceFormula = DynamicValue.readOrDefaultMessage(json
                .dvf, RPM.STRING_ZERO);
            this.isDamageCritical = RPM.defaultValue(json.idc, false);
            this.damageCriticalFormula = DynamicValue.readOrDefaultMessage(json
                .dcf, RPM.STRING_ZERO);
            this.isDamagePrecision = RPM.defaultValue(json.idp, false);
            this.damagePrecisionFormula = DynamicValue.readOrDefaultMessage(json
        ...
        case EffectKind.Status:
            ...
            this.statusPrecisionFormula = DynamicValue.readOrDefaultMessage(json
        ...
        this.temporarilyChangeTargetFormula = DynamicValue.readOrDefaultMessage(
            json.tctf);
    }
